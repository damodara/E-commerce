...
def test_product_new_product_with_duplicate_check():
    """Проверяет работу класс-метода с проверкой дубликатов."""
    existing_products = [
        Product("Existing Product", "Desc", 100.0, 5)
    ]
...
def test_product_new_product_with_duplicate_check_no_duplicate():
